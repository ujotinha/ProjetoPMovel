...
class bodyAutocuidado extends StatefulWidget {


  bodyAutocuidado({super.key});

  @override
  State<bodyAutocuidado> createState() => _bodyAutocuidadoState();
}

class _bodyAutocuidadoState extends State<bodyAutocuidado> {
  @override
