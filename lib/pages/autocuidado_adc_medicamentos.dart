...
class AutocuidadoAdcMedicamentos extends StatefulWidget {
  ...
  @override
  State<AutocuidadoAdcMedicamentos> createState() =>
      _AutocuidadoAdcMedicamentosState();
}

class _AutocuidadoAdcMedicamentosState
    extends State<AutocuidadoAdcMedicamentos> {
  @override
              ...
              children: [
                ...
                Text("Medicamentos",
                    style: GoogleFonts.radley(
                        color: Color(0xFF7b4a28), fontSize: 20))
              ],
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text("Nome do Medicamento:",
                      style: GoogleFonts.radley(
                          fontSize: 16, color: Color(0xFF7b4a28))),
                ],
              ),
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Notificação",
                    style: GoogleFonts.radley(
                        fontSize: 16, color: Color(0xFF7b4a28), height: 1.3),
                  ),
                  IconButton(
                      onPressed: () {},
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        "Salvar",
                        style: GoogleFonts.radley(fontSize: 16, height: 1.3),
                      ),
