...
class CuidarPaciente extends StatefulWidget {
  const CuidarPaciente({super.key});

  @override
  State<CuidarPaciente> createState() => _CuidarPacienteState();
}

class _CuidarPacienteState extends State<CuidarPaciente> {
  @override
